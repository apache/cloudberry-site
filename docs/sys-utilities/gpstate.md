...
|CloudberryDB initsystem version|version of Apache Cloudberry when system was first initialized|
|CloudberryDB current version|current version of Apache Cloudberry|
