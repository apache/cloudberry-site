...
source: https://cloudberry.apache.org/docs/next/performance/memory-overview
---
...
The physical RAM and OS configuration are usually managed by the platform team and system administrators. See the [Software and Hardware Requirements](../deployment/platform-requirements.md) for the recommended kernel parameters and for how to set the `/etc/sysctl.conf` file parameters.
