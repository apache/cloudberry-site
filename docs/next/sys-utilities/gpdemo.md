---
title: "gpdemo"
source: https://cloudberry.apache.org/docs/next/sys-utilities/gpdemo
---
...
- When the parameter value is set to 0, a single-computing-node cluster is deployed. See [Deploy Apache Cloudberry with a Single Computing Node](../deployment/single-node.md) for details.
:::
