...
source: https://cloudberry.apache.org/docs/next/sys-admin/high-availability/enable-segment-mirroring
---
...
1. Ensure the Apache Cloudberry software is installed on all hosts. See the [Apache Cloudberry Installation Guide](../../deployment/index.md) for detailed installation instructions.
