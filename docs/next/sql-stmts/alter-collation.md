...
source: https://cloudberry.apache.org/docs/next/sql-stmts/alter-collation
---
...
[CREATE COLLATION](/docs/sql-stmts/create-collation.md), [DROP COLLATION](/docs/sql-stmts/drop-collation.md)
