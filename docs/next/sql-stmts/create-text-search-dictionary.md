...
source: https://cloudberry.apache.org/docs/next/sql-stmts/create-text-search-dictionary
---
...
[ALTER TEXT SEARCH DICTIONARY](/docs/sql-stmts/alter-text-search-dictionary.md), [DROP TEXT SEARCH DICTIONARY](/docs/sql-stmts/drop-text-search-dictionary.md)
