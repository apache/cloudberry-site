...
source: https://cloudberry.apache.org/docs/next/sql-stmts/create-text-search-template
---
...
[DROP TEXT SEARCH TEMPLATE](/docs/sql-stmts/drop-text-search-template.md), [ALTER TEXT SEARCH TEMPLATE](/docs/sql-stmts/alter-text-search-template.md)
