...
source: https://cloudberry.apache.org/docs/next/tutorials/best-practices/system-configuration-best-practices
---
...
XFS is the file system used for Apache Cloudberry data directories. Use the mount options described in [Configuring Your Systems](../../deployment/prepare-to-deploy#xfs-mount-options).
