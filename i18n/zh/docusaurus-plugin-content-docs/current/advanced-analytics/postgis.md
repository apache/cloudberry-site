...
要查看 Apache Cloudberry PostGIS 项目的仓库，请访问 [`cloudberrydb/postgis`](https://github.com/cloudberrydb/postgis)。该仓库的 PostGIS 是专门为 Apache Cloudberry 打造的，本文档介绍的编译构建方法，是基于该仓库的代码。
...
在开始编译之前，请确保 Apache Cloudberry 已正确安装。如果尚未安装，请参阅[文档](https://cloudberrydb.org/zh/docs/)获取安装说明。
