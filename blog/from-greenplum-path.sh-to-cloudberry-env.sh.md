...
source: https://cloudberry.apache.org/blog/from-greenplum-path.sh-to-cloudberry-env.sh
---

# Goodbye `greenplum_path.sh`, Hello `cloudberry-env.sh`: A Phased Transition Plan
